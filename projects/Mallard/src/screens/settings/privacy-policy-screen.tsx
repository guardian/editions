...
const privacyPolicyHtml = html`
    ...
    <ul>
        ...
        <li>
            When we refer to &lsquo;personal data&rsquo; in this privacy policy,
            we are also referencing &lsquo;personal information&rsquo; as
            defined by Australian privacy law.
        </li>
    </ul>
    ...
    <p>
        ...
        details in the &ldquo;How to contact us&rdquo; section below.
    </p>
    ...
    <ul>
        ...
        <li>
            ...
            tab &ldquo;Emails and marketing&rdquo;
        </li>
        <li>
    ...
    <ul>
        <li>
            ...
            consent by clicking on the &ldquo;unsubscribe&rdquo; link at the
            bottom of the email or through your email preferences in the
            &ldquo;emails and marketing&rdquo; tab, when signed into your
            Guardian account.
        </li>
        <li>
            <em
    ...
    <p>
        ...
        your preferences through the tab &ldquo;Emails and marketing&rdquo; when
    ...
    <ul>
        ...
        <li>
            ...
            analysis, you can change your settings in the &ldquo;Emails and
            marketing&rdquo; tab of your Guardian account
        </li>
    </ul>
    ...
    <p>
        ...
        can refer your complaint to the Information Commissioner&rsquo;s Office.
    </p>
