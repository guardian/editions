...
<p>
	This is a privacy policy for the Guardian Editions app. The privacy policy explains how we (Guardian News &amp; Media Limited) collect, use, share and transfer your personal data when you use the Guardian Editions app. This is separate to how we collect and use your personal data on theguardian.com, which is explained on the website <strong>( https://www.theguardian.com/help/privacy-policy )</strong>. 
</p>

<p>
	Where this app contains links to third party sites, you should read the privacy policy shown on their site.
</p>

<p>
	To compliment our global approach to privacy protection, this policy also incorporates specific information privacy rights granted to individuals under Australian privacy law to reflect our relationship with our Australian readers of the Australian Edition in the app.
</p>
...
<p>
	The data controller for the Guardian Editions is Guardian News &amp; Media Limited, Kings Place, 90 York Way, London N1 9GU. This means that we are responsible for deciding how and why we hold and use your personal data. If you want to contact us, you can find our contact details in the &ldquo;How to contact us&rdquo; section below.
</p>
...
<p>
	<strong>
		When you use  the Guardian Editions app
	</strong>
</p>
...
<p>
	You can manage our use of your personal data through the Privacy Settings feature in the app. You can also delete the list of articles that you have recently viewed and cached in the local storage on your mobile device via the settings of the app. You can also manage receiving notifications on your mobile device via the app in the settings of the app.
</p>
...
<ul>
	...
	<li>To send marketing communications when we have your permission, or when permitted by law</li>
	<li>To remember your settings and to recognise you when you sign in on different devices</li>
	<li>To carry out marketing analysis, for example, we look at what you have viewed on this app to determine whether we think you might be interested in hearing from us about our other Guardian products and services. You can opt out from having your personal data used for marketing analysis by going into your theguardian.com account to the tab &ldquo;Emails and marketing&rdquo;</li>
	<li>To analyse the performance of this app and to understand how visitors use it</li>
...
<p>
	We also use information on the content you have viewed on our sites and apps and your interaction with the content to add you to groups with similar interests and preferences, so that we can make our online advertising on our other sites and apps more relevant to you. Sometimes we use data about your interests or demographics that third parties have collected from you online to add to these groups. The way we use personal data to provide personalised advertising is described in our cookie policy <strong>( https://www.theguardian.com/info/cookies )</strong>.
</p>

<p>
	<strong>
		Using children&rsquo;s personal data
	</strong>
</p>

<p>
	This app is not aimed directly at children under the age of 13[a][b][c] and we do not knowingly collect personal data via this app about children under 13. Some of our services may have a higher age restriction and this will be shown at the point of registration.
</p>
...
<p>
	While there is no online advertising on this app, we may send you materials we think may interest you, such as new Guardian offers and updates, if we have your permission. Depending on your marketing preferences, this may be by email, phone, SMS or post. You can manage your preferences  through the tab &ldquo;Emails and marketing&rdquo; when you are signed in to your Guardian account through our website.
</p>
...
<p>
	If you are not satisfied with the way your concern has been handled, you can refer your complaint to the Information Commissioner&rsquo;s Office.
</p>

<p>
	If you have a question about anything else, please see our Contact us information under Settings -> Help in this app.
</p>
...
<p>
	We post changes that we make to our privacy policy here. If the changes are significant, we may also choose to email all our registered users with the new details. If required by law, we will get your permission or give you the opportunity to opt out of any new uses of your data. The most recent changes to this privacy policy were made in May 2020 and October 2020. Other changes are available upon request.
</p>
`
