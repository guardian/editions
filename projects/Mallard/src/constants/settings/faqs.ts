export const html = `
	...
	<p>
		...
		top right corner <img src="burgerMenu" />, then tap the cog icon
		<img src="settingsCog" /> to open settings and select Help. You can also email
